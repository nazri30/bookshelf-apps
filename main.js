      ...
      if (book.title.toLowerCase().includes(inputSearchValue)) {
         if (book.isCompleted == false) {
            ...
            <article class="book_item">
               ...
               <div class="action">
                  <button class="ayah-tiri" onclick="changeBookStatus(${book.id})">Selesai di Baca</button>
                  <button class="mamah" onclick="removeBook(${book.id})">Hapus Buku</button>
            ...
            <article class="book_item">
               ...
               <p>Tahun Terbit : ${book.year}</p>
               <div class="action">
                  <button class="ayah-tiri" onclick="changeBookStatus(${book.id})">Belum selesai di Baca</button>
                  <button class="mamah" onclick="removeBook(${book.id})">Hapus Buku</button>
                  <button class="btn-orange" onclick="editBookData(${book.id})">Edit buku</button>
                  </div>
            </article>
      ...
      if (book.isCompleted == false) {
         let el = `
            <article class="book_item">
               ...
               <p>Tahun Terbit : ${book.year}</p>
               <div class="action">
                  <button class="ayah-tiri" onclick="changeBookStatus(${book.id})"><i class='bx bx-check-circle bx-tada' ></i></button>
                  <button class="mamah" onclick="removeBook(${book.id})"><i class='bx bxs-trash bx-tada' ></i></button>
                  <button class="btn-orange" onclick="editBookData(${book.id})"><i class='bx bx-edit bx-tada' ></i></button>
               </div>
            </article>
            `;
         ...
         let el = `
            <article class="book_item">
               ...
               <p>Tahun Terbit : ${book.year}</p>
               <div class="action">
                  <button class="btn-green" onclick="changeBookStatus(${book.id})"><i class='bx bx-check-circle bx-tada' ></i></button>
                  <button class="btn-red" onclick="removeBook(${book.id})"><i class='bx bxs-trash bx-tada' ></i></button>
                  <button class="btn-orange" onclick="editBookData(${book.id})"><i class='bx bx-edit bx-tada' ></i></button>
                  </div>
            </article>
            `;
